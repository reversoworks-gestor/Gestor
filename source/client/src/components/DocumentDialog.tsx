        ...
        <fieldset disabled={readOnly} style={{ border: 0, margin: 0, minWidth: 0, padding: 0 }}>
          <div className="document-grid">
            ...
            <section className="document-section payment-section">
              <div className="section-caption"><CircleDollarSign size={17} /><span>Pagamentos</span><button type="button" className="button button-secondary payment-add-button" onClick={() => change({ ...order, payments: [...(order.payments ?? []), { id: makeId("payment"), method: "Pix", amount: 0, amountCents: 0, date: new Date().toISOString().slice(0, 10) } as Payment] })}><Plus size={14} /> Adicionar</button></div>
